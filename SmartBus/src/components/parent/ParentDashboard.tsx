...
export function ParentDashboard({ parentInfo }: ParentDashboardProps) {
  const currentStatus = {
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <Badge className="bg-blue-100 text-blue-800">{child.route}</Badge>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={currentStatus.onTime ? 'text-green-600' : 'text-red-600'}>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{todaySchedule.pickupTime}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm">Đón (thực tế):</span>
                  <div className="flex items-center gap-2">
                    <span className="font-medium">{todaySchedule.actualPickup || '--:--'}</span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{todaySchedule.dropoffTime}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm">Trả (thực tế):</span>
                  <div className="flex items-center gap-2">
                    <span className="font-medium">{todaySchedule.actualDropoff || '--:--'}</span>
              ...
              <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-4">
                  <div className="text-center">
                    <p className="font-medium">{new Date(trip.date).getDate()}</p>
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-4">
                      <div className="text-sm">
                        ...
                        <span className="font-medium ml-1">{trip.actualPickup}</span>
                        <span className="text-muted-foreground ml-1">({trip.pickupTime})</span>
                      </div>
                      <div className="text-sm">
                        <span className="text-muted-foreground">Trả:</span>
                        <span className="font-medium ml-1">{trip.actualDropoff}</span>
                        <span className="text-muted-foreground ml-1">({trip.dropoffTime})</span>
                      </div>
                    </div>
                  </div>
                </div>
