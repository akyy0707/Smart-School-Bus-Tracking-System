...
interface NotificationDemoProps {
  userRole: 'driver' | 'manager' | 'parent';
  loginKey: string; // Unique key cho mỗi lần đăng nhập
}

export function NotificationDemo({ userRole, loginKey }: NotificationDemoProps) {
