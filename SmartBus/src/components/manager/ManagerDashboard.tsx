...
export function ManagerDashboard() {
  ...
  const vehicleStatus = [
    { status: 'Đang hoạt động', count: 22, color: 'bg-green-500', percentage: 88 },
    { status: 'Nghỉ giải lao', count: 2, color: 'bg-yellow-500', percentage: 8 },
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold">{stats.activeDrivers}/{stats.totalDrivers}</p>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold">{stats.activeVehicles}/{stats.totalVehicles}</p>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold">{stats.totalStudents.toLocaleString()}</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="font-medium">{stats.completedTrips}/200</span>
                  </div>
                  <Progress value={(stats.completedTrips / 200) * 100} className="h-2" />
                </div>
              </div>
                  ...
                  <div key={index} className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-sm font-medium">{status.count} xe</span>
                      </div>
                  ...
                  <div key={alert.id} className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    >
                      {alert.severity === 'high' ? 'Khẩn cấp' :
                       alert.severity === 'medium' ? 'Quan trọng' : 'Thông tin'}
                    </Badge>
                  </div>
                ))}
              </div>
