...
export function ManagerStudents() {
  ...
  const filteredStudents = students.filter(student => {
    ...
    const matchesRoute = filterRoute === 'all' || student.busRoute === filterRoute;
  ...
  const getStatusBadge = (status: Student['status']) => {
    switch (status) {
      ...
      case 'graduated':
        return <Badge className="bg-blue-100 text-blue-800">Đã tốt nghiệp</Badge>;
      case 'transferred':
        return <Badge className="bg-yellow-100 text-yellow-800">Chuyển trường</Badge>;
      default:
  ...
  const handleSaveStudent = (isEdit: boolean = false) => {
    if (!formData.name || !formData.grade || !formData.class || !formData.parentName) {
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Select value={formData.status || 'active'} onValueChange={(value) => setFormData({ ...formData, status: value as Student['status'] })}>
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold`}>{totalStudents}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold text-green-600`}>{activeStudents}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold text-gray-600`}>{inactiveStudents}</p>
              </div>
                    ...
                    <TableRow key={student.id}>
                      ...
                      <TableCell>
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">{student.busStop}</p>
                        </div>
                      </TableCell>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Bạn có chắc chắn muốn xóa học sinh "{student.name}"? 
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
          <DialogHeader>
            ...
            <DialogDescription>
              Điền thông tin đầy đủ cho học sinh mới. Các trường có dấu (*) là bắt buộc.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
          ...
          <div className="flex justify-end gap-2 pt-4">
            ...
            <Button onClick={() => handleSaveStudent(true)}>
              Cập nhật
            </Button>
          </div>
        </DialogContent>
