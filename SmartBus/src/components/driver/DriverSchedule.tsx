                          ...
                          <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                ...
                                <p className="text-muted-foreground">{selectedSchedule.id}</p>
                              </div>
                              <div>
                              ...
                              <div>
                                ...
                                <p className="text-muted-foreground">{selectedSchedule.vehiclePlate}</p>
                              </div>
                            </div>
                            ...
                            {routeDetails[selectedSchedule.id] && (
                              <div className="space-y-4">
                                <h4 className="font-medium">Điểm dừng trên tuyến</h4>
                                
                                <div className="space-y-4">
                                  <div>
                                    <h5 className="text-sm font-medium mb-2">Lượt đi</h5>
                                    <div className="space-y-2">
                                      {routeDetails[selectedSchedule.id].stops.map((stop, index) => (
                                        <div key={index} className="flex items-center gap-3 p-2 bg-gray-50 rounded">
                                          <MapPin className="w-4 h-4 text-blue-600" />
                                          <div className="flex-1">
                                            <p className="font-medium">{stop.name}</p>
                                            <p className="text-sm text-muted-foreground">
                                              {stop.time} • Cách {stop.distance} km
                                            </p>
                                          </div>
                                        </div>
                                      ))}
                                  ...
                                  <div>
                                    <h5 className="text-sm font-medium mb-2">Lượt về</h5>
                                    <div className="space-y-2">
                                      {routeDetails[selectedSchedule.id].returnStops.map((stop, index) => (
                                        <div key={index} className="flex items-center gap-3 p-2 bg-gray-50 rounded">
